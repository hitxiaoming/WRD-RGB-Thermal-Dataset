...
def parse_args():
    ...
    parser.add_argument('--config',default="configs/db_convnextv2.py", help='train config file path')
    parser.add_argument('--work-dir',default="weight/db_convnextv2", help='the dir to save logs and models')
    parser.add_argument(
        '--resume',
        nargs='?',
        type=str,
