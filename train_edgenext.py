...
def parse_args():
    ...
    parser.add_argument('--config', default="configs/dual_stream_modules_edgenext.py", help='train config file path')
    parser.add_argument('--work-dir', default="weight/sp_edgenext", help='the dir to save logs and models')
    parser.add_argument(
        '--resume',
        nargs='?',
        type=str,
